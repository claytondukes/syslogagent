...
#define NTSL_ERROR_EVENT_MALLOC \
			L"Unable to create event - out of memory"
...
#define NTSL_ERROR_TIME_DATA_WRITE \
			L"Unable to write to registry: %s"
...
#define NTSL_ERROR_CONFIG_READ \
			L"Unable to read access registry key: %s"
